...
export const Intro = () => {
  return (
    ...
    <h2 id="inicio" className=' text-center  text-7xl  dark:text-white mb-1 md:mb-3 tracking-tighter animate-pulse font-bold'> Arostegui Maranto</h2>
    <br/>
...
<br/>
  ...
  <div class=" bg-stone p-8 rounded-lg dark:shadow-inner dark:shadow-white shadow-md flex items-center">
        <div class="w-1/3">
            <img  src="/assets/123.png" alt="Imagen" class="w-full h-auto rounded-full  origin-top-left "/>
        </div>
        <div class="w-2/3 p-12 text-left ml-4">
