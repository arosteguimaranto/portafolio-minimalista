...
export const Intro = () => {
  return (
    ...
    <br/>
    <p className=' tracking-tight md:text-4xl mb-3  font-mono'> <strong> Desarrollador Web </strong> </p>
    <br/>
    <br/>
...
<br/>
  ...
  <div class=" bg-stone p-8 rounded-lg  shadow-lg flex items-center">
    ...
    <div class=" w-full">
        <h2 class="tracking-tight md:text-3xl mb-3 text-center font-mono "><strong>Tecnologias</strong> </h2>
        <ul class=" text-xl  flex flex-wrap justify-between dark:bg-slate-100/80 bg-stone-950 text-white dark:text-black tracking-tight font-semibold  hover:text-yellow-300 transform hover:scale-110 duration-300 border rounded-lg  ">
        ...
        <li class="my-2 p-1 flex-none "> </li>
      </ul>
    </div>
</div>
